...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PokemonHyperiaMMO", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PokemonHyperiaMMO", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PokemonHyperiaMMO";
		app.meta["name"] = "PokemonHyperiaMMO";
